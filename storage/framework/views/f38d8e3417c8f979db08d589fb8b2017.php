 <?php $__env->startSection('content'); ?> <?php echo $__env->make('layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('modules.hero-banner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="grid__wrap stack">
            <div class="grid grid--middle grid--space-24 grid--lg-space-56">
                <div class="grid__1-1 grid__lg-1-2">
                    ...
                    data-wow-delay="0.3s" title="Kadeřnice Terka" alt="Kadeřnice Terka" src="<?php echo e(URL::asset("img/terka.webp")); ?>">
                </div>
                <div class="grid__1-1 grid__lg-1-2">
                    <cite
        ...
        >
            <div class="grid grid--middle grid--space-8 grid--lg-space-56">
                <div class="grid__1-1 grid__lg-1-4">
                    ...
                    alt="Alcina" title="Alcina" src="<?php echo e(URL::asset("img/barvy_alcina.webp")); ?>">
                    <!-- <img class="img img--add1" alt="Alcina" title="Alcina" src="<?php echo e(URL::asset("img/alcina2.webp")); ?>"> -->
                </div>
        ...
        >
            <div class="grid grid--middle grid--right grid--space-8 grid--lg-space-56">
                ...
                <div class="grid__1-1 grid__lg-1-4 relative">
                    ...
                    alt="Alcina" title="Alcina" src="<?php echo e(URL::asset("img/malibu1.webp")); ?>">
                    <!-- <img class="img img--add1" alt="Alcina" title="Alcina" src="<?php echo e(URL::asset("img/malibu2.webp")); ?>">
                        <img class="img img--add2" alt="Alcina" title="Alcina" src="<?php echo e(URL::asset("img/malibu3.webp")); ?>"> -->
                </div>
            </div>
        </div>
    </div>
...
<section class="stripe" id="cenik">
    <div class="container">
        <div class="stack typo--center">
            <a
                href="<?php echo e(URL::asset('files/cenik.png')); ?>"
        ...
        <div class="gallery stack">
            <div class="grid__wrap">
                <div class="grid grid--space-24">
                    <?php $__currentLoopData = Storage::disk('public2')->files('gallery'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="grid__1-2 grid__md-1-3 grid__lg-1-4">
                        <a
                            data-pswp-width="700"
                            data-pswp-height="1000"
                            href="<?php echo e(URL::asset($i)); ?>"
                            aria-label="Obrázek v galerii"
                            class="grid__height"
                            ><img
                                loading="lazy"
                                src="<?php echo e(URL::asset($i)); ?>"
...
<?php echo $__env->make('layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\weby\kadernictvi2023\resources\views/content/homepage.blade.php ENDPATH**/ ?>