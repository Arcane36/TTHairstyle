<header class="fixed">
    <div class="container">
        ...
        <nav class="menu">        
            <a href="#top">
                <img class="menu__logo" src=<?php echo e(URL::asset("img/logo.svg")); ?> width="289" height="171" aria-label="Hlavní logo webu" alt="Hlavní logo" title="Hlavní logo">
            </a>
...
</header><?php /**PATH F:\weby\kadernictvi2023\resources\views/layout/header.blade.php ENDPATH**/ ?>