...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <link rel="shortcut icon" href="<?php echo e(URL::asset('img/logo.svg')); ?>" type="image/x-icon">
        ...
        <link rel="preload" as="image" href="<?php echo e(URL::asset("/img/final.webp")); ?>">
        <link rel="preload" as="image" href="<?php echo e(URL::asset("/img/terka.webp")); ?>">

        <!-- Fonts -->

        <!-- Styles -->
        <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset("css/style.css")); ?>?<?php echo e(md5(microtime())); ?>" rel="preload" as="style" />
        ...
        <script defer src=<?php echo e(URL::asset("js/photoswipe.esm.min.js")); ?>></script>
        <script defer src=<?php echo e(URL::asset("js/photoswipe-lightbox.esm.min.js")); ?>></script>
        <script async src="<?php echo e(URL::asset("js/main.js")); ?>?<?php echo e(md5(microtime())); ?>"></script>
...
<?php /**PATH F:\weby\kadernictvi2023\resources\views/layout/default.blade.php ENDPATH**/ ?>